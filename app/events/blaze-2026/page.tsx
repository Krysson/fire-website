...
export const metadata: Metadata = {
  title: 'BLAZE 2026 - Beginner to Intermediate Rope Event',
  description: 'BLAZE 2026 is a beginner to intermediate focused rope bondage event taking place April 17-19, 2026 in Orlando, FL. Join us for an intimate weekend of learning and connection.',
  openGraph: {
    title: 'BLAZE 2026 - Ignite Your Rope Journey',
    description: 'Beginner to intermediate rope bondage education event in Orlando, FL. April 17-19, 2026.',
    type: 'website',
    url: 'https://fireorlando.com/events/blaze-2026',
  },
};
  ...
  const navigationCards = [
    {
      ...
      href: '/events/blaze-2026/schedule',
      icon: Calendar,
    },
    {
      title: 'Presenters',
      description: 'Meet our talented instructors',
      href: '/events/blaze-2026/presenters',
      icon: Users,
    },
    {
      title: 'Classes',
      description: 'Browse all available classes',
      href: '/events/blaze-2026/classes',
      icon: Calendar,
    },
    {
      title: 'Venue',
      ...
      <div className="relative z-10 py-3 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-gray-400">
            ...
            <span>/</span>
            <span className="text-fire-orange">BLAZE 2026</span>
          </div>
        </div>
      </div>
      ...
      <section className="relative z-10 border-t border-fire-dark/50 bg-gradient-to-b from-fire-charcoal/50 to-fire-dark py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mb-8 text-lg text-gray-300">
            Join us for an unforgettable weekend of learning and connection
          </p>
          <a
            href={event.tickets.url}
            target="_blank"
