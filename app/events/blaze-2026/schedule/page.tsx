...
import { getEventData, getSchedule } from '@/lib/content';
import ScheduleGrid from '@/components/events/ScheduleGrid';
import type { Metadata } from 'next';

export const metadata: Metadata = {
  title: 'BLAZE 2026 Schedule',
  description: 'View the full schedule for BLAZE 2026, including classes, workshops, and special events throughout the weekend.',
  openGraph: {
    title: 'BLAZE 2026 Schedule',
