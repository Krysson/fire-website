    ...
    <footer className="bg-fire-charcoal border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          {/* About Column */}
          <div>
            <h3 className="text-fire-orange font-bold text-lg mb-4">
              About FIRE
            </h3>
            <p className="text-gray-300 text-sm leading-relaxed mb-4">
              FIRE (Florida Intensive Rope Events) is an educational organization
              dedicated to promoting rope bondage education through three annual
              conventions in Orlando, FL: BLAZE, FLARE, and FIRE.
            </p>
            <a
